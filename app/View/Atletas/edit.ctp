...
<div class="span12">
 ...
 ?> 
                        ...
                        <?php 		echo $this->Form->input('data_nascimento',array('label' => false, 'value' => $this->Locale->date($atleta['Atleta']['data_nascimento']) , 'class' => 'data', 'type' => 'text', 'div' => array('class' => 'span9') ));
 ?> 
                       </div> <div class='row-form clearfix'> 
 ...
 ?> 
                        ...
                        <?php 		echo $this->Form->input('atestado_medico',array('label' => false, 'div' => array('class' => 'span9') ));
 ?> 
                       </div> <div class='row-form clearfix'> 
