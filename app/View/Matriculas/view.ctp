        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="table">
            <thead>
                <tr> 
                    ...
                    <th width='15%' class="actions"><?php echo __('Ações'); ?></th>
                </tr>
            </thead>
            <tbody>
 ...
 ?>&nbsp;</td>
		<td class="actions">
			<?php 
                           ...
                           // echo $this->Html->link(__(), array('action' => 'edit', $matricula['Matricula']['id']), array('class' => 'ibb-cancel anular '.$mensalidade['Mensalidade']['id'], 'title' => 'Anular')); 
                            }
                            ?>
</td>
	</tr>
